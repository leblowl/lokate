...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t25005 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t25005 = (function (val,box,meta25006){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t25005.cljs$lang$type = true;
cljs.core.async.impl.channels.t25005.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t25005";
cljs.core.async.impl.channels.t25005.cljs$lang$ctorPrWriter = (function (this__13123__auto__,writer__13124__auto__,opt__13125__auto__){return cljs.core._write.call(null,writer__13124__auto__,"cljs.core.async.impl.channels/t25005");
});
cljs.core.async.impl.channels.t25005.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t25005.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25007){var self__ = this;
var _25007__$1 = this;return self__.meta25006;
});
cljs.core.async.impl.channels.t25005.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25007,meta25006__$1){var self__ = this;
var _25007__$1 = this;return (new cljs.core.async.impl.channels.t25005(self__.val,self__.box,meta25006__$1));
});
cljs.core.async.impl.channels.__GT_t25005 = (function __GT_t25005(val__$1,box__$1,meta25006){return (new cljs.core.async.impl.channels.t25005(val__$1,box__$1,meta25006));
});
}
return (new cljs.core.async.impl.channels.t25005(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj25009 = {};return obj25009;
})();
...
{}
while(true){
var taker_25010 = self__.takes.pop();if((taker_25010 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_25010))
{var take_cb_25011 = cljs.core.async.impl.protocols.commit.call(null,taker_25010);var val_25012 = (cljs.core.truth_((function (){var and__12534__auto__ = self__.buf;if(cljs.core.truth_(and__12534__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__12534__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_25011,val_25012,taker_25010,this$__$1){
return (function (){return take_cb_25011.call(null,val_25012);
});})(take_cb_25011,val_25012,taker_25010,this$__$1))
);
} else
{}
{
...
{} else
{var putter_25013 = self__.puts.pop();if((putter_25013 == null))
{} else
{var put_handler_25014 = putter_25013.handler;var val_25015 = putter_25013.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_25014))
{var put_cb_25016 = cljs.core.async.impl.protocols.commit.call(null,put_handler_25014);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_25016,put_handler_25014,val_25015,putter_25013,_,retval,this$__$1){
return (function (){return put_cb_25016.call(null,true);
});})(put_cb_25016,put_handler_25014,val_25015,putter_25013,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_25015)))
...
{var taker_25017 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_25017))
{var take_cb_25018 = cljs.core.async.impl.protocols.commit.call(null,taker_25017);var val_25019__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_25018,val_25019__$1,taker_25017,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_25018.call(null,val_25019__$1);
});})(take_cb_25018,val_25019__$1,taker_25017,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_25020 = self__.puts.pop();if((putter_25020 == null))
{} else
{var put_handler_25021 = putter_25020.handler;var val_25022 = putter_25020.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_25021))
{var put_cb_25023 = cljs.core.async.impl.protocols.commit.call(null,put_handler_25021);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_25023,put_handler_25021,val_25022,putter_25020,this$__$1){
return (function (){return put_cb_25023.call(null,true);
});})(put_cb_25023,put_handler_25021,val_25022,putter_25020,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__25028 = null;
var G__25028__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e25026){var t = e25026;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__25028__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e25027){var t = e25027;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__25028 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__25028__1.call(this,buf__$1);
case 2:
return G__25028__2.call(this,buf__$1,val);
}
