...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t24232 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t24232 = (function (val,box,meta24233){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t24232.cljs$lang$type = true;
cljs.core.async.impl.channels.t24232.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t24232";
cljs.core.async.impl.channels.t24232.cljs$lang$ctorPrWriter = (function (this__13123__auto__,writer__13124__auto__,opt__13125__auto__){return cljs.core._write.call(null,writer__13124__auto__,"cljs.core.async.impl.channels/t24232");
});
cljs.core.async.impl.channels.t24232.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t24232.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24234){var self__ = this;
var _24234__$1 = this;return self__.meta24233;
});
cljs.core.async.impl.channels.t24232.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24234,meta24233__$1){var self__ = this;
var _24234__$1 = this;return (new cljs.core.async.impl.channels.t24232(self__.val,self__.box,meta24233__$1));
});
cljs.core.async.impl.channels.__GT_t24232 = (function __GT_t24232(val__$1,box__$1,meta24233){return (new cljs.core.async.impl.channels.t24232(val__$1,box__$1,meta24233));
});
}
return (new cljs.core.async.impl.channels.t24232(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj24236 = {};return obj24236;
})();
...
{}
while(true){
var taker_24237 = self__.takes.pop();if((taker_24237 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_24237))
{var take_cb_24238 = cljs.core.async.impl.protocols.commit.call(null,taker_24237);var val_24239 = (cljs.core.truth_((function (){var and__12534__auto__ = self__.buf;if(cljs.core.truth_(and__12534__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__12534__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_24238,val_24239,taker_24237,this$__$1){
return (function (){return take_cb_24238.call(null,val_24239);
});})(take_cb_24238,val_24239,taker_24237,this$__$1))
);
} else
{}
{
...
{} else
{var putter_24240 = self__.puts.pop();if((putter_24240 == null))
{} else
{var put_handler_24241 = putter_24240.handler;var val_24242 = putter_24240.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_24241))
{var put_cb_24243 = cljs.core.async.impl.protocols.commit.call(null,put_handler_24241);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_24243,put_handler_24241,val_24242,putter_24240,_,retval,this$__$1){
return (function (){return put_cb_24243.call(null,true);
});})(put_cb_24243,put_handler_24241,val_24242,putter_24240,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_24242)))
...
{var taker_24244 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_24244))
{var take_cb_24245 = cljs.core.async.impl.protocols.commit.call(null,taker_24244);var val_24246__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_24245,val_24246__$1,taker_24244,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_24245.call(null,val_24246__$1);
});})(take_cb_24245,val_24246__$1,taker_24244,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_24247 = self__.puts.pop();if((putter_24247 == null))
{} else
{var put_handler_24248 = putter_24247.handler;var val_24249 = putter_24247.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_24248))
{var put_cb_24250 = cljs.core.async.impl.protocols.commit.call(null,put_handler_24248);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_24250,put_handler_24248,val_24249,putter_24247,this$__$1){
return (function (){return put_cb_24250.call(null,true);
});})(put_cb_24250,put_handler_24248,val_24249,putter_24247,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__24255 = null;
var G__24255__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e24253){var t = e24253;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__24255__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e24254){var t = e24254;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__24255 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__24255__1.call(this,buf__$1);
case 2:
return G__24255__2.call(this,buf__$1,val);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__24255.cljs$core$IFn$_invoke$arity$1 = G__24255__1;
