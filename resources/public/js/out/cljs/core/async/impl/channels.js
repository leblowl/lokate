...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t24057 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t24057 = (function (val,box,meta24058){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t24057.cljs$lang$type = true;
cljs.core.async.impl.channels.t24057.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t24057";
cljs.core.async.impl.channels.t24057.cljs$lang$ctorPrWriter = (function (this__13123__auto__,writer__13124__auto__,opt__13125__auto__){return cljs.core._write.call(null,writer__13124__auto__,"cljs.core.async.impl.channels/t24057");
});
cljs.core.async.impl.channels.t24057.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t24057.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_24059){var self__ = this;
var _24059__$1 = this;return self__.meta24058;
});
cljs.core.async.impl.channels.t24057.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_24059,meta24058__$1){var self__ = this;
var _24059__$1 = this;return (new cljs.core.async.impl.channels.t24057(self__.val,self__.box,meta24058__$1));
});
cljs.core.async.impl.channels.__GT_t24057 = (function __GT_t24057(val__$1,box__$1,meta24058){return (new cljs.core.async.impl.channels.t24057(val__$1,box__$1,meta24058));
});
}
return (new cljs.core.async.impl.channels.t24057(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj24061 = {};return obj24061;
})();
...
{}
while(true){
var taker_24062 = self__.takes.pop();if((taker_24062 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_24062))
{var take_cb_24063 = cljs.core.async.impl.protocols.commit.call(null,taker_24062);var val_24064 = (cljs.core.truth_((function (){var and__12534__auto__ = self__.buf;if(cljs.core.truth_(and__12534__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__12534__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_24063,val_24064,taker_24062,this$__$1){
return (function (){return take_cb_24063.call(null,val_24064);
});})(take_cb_24063,val_24064,taker_24062,this$__$1))
);
} else
{}
{
...
{} else
{var putter_24065 = self__.puts.pop();if((putter_24065 == null))
{} else
{var put_handler_24066 = putter_24065.handler;var val_24067 = putter_24065.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_24066))
{var put_cb_24068 = cljs.core.async.impl.protocols.commit.call(null,put_handler_24066);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_24068,put_handler_24066,val_24067,putter_24065,_,retval,this$__$1){
return (function (){return put_cb_24068.call(null,true);
});})(put_cb_24068,put_handler_24066,val_24067,putter_24065,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_24067)))
...
{var taker_24069 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_24069))
{var take_cb_24070 = cljs.core.async.impl.protocols.commit.call(null,taker_24069);var val_24071__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_24070,val_24071__$1,taker_24069,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_24070.call(null,val_24071__$1);
});})(take_cb_24070,val_24071__$1,taker_24069,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_24072 = self__.puts.pop();if((putter_24072 == null))
{} else
{var put_handler_24073 = putter_24072.handler;var val_24074 = putter_24072.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_24073))
{var put_cb_24075 = cljs.core.async.impl.protocols.commit.call(null,put_handler_24073);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_24075,put_handler_24073,val_24074,putter_24072,this$__$1){
return (function (){return put_cb_24075.call(null,true);
});})(put_cb_24075,put_handler_24073,val_24074,putter_24072,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__24080 = null;
var G__24080__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e24078){var t = e24078;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__24080__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e24079){var t = e24079;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__24080 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__24080__1.call(this,buf__$1);
case 2:
return G__24080__2.call(this,buf__$1,val);
}
