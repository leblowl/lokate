...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_15224 = (0);while(true){
var m_15225 = cljs.core.async.impl.dispatch.tasks.pop();if((m_15225 == null))
{} else
{m_15225.call(null);
if((count_15224 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__15226 = (count_15224 + (1));
count_15224 = G__15226;
continue;
}
} else
{}
