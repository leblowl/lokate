...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_30980 = (0);while(true){
var m_30981 = cljs.core.async.impl.dispatch.tasks.pop();if((m_30981 == null))
{} else
{m_30981.call(null);
if((count_30980 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__30982 = (count_30980 + (1));
count_30980 = G__30982;
continue;
}
} else
{}
