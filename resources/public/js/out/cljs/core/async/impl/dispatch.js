...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_24999 = (0);while(true){
var m_25000 = cljs.core.async.impl.dispatch.tasks.pop();if((m_25000 == null))
{} else
{m_25000.call(null);
if((count_24999 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__25001 = (count_24999 + (1));
count_24999 = G__25001;
continue;
}
} else
{}
