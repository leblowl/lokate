...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_24051 = (0);while(true){
var m_24052 = cljs.core.async.impl.dispatch.tasks.pop();if((m_24052 == null))
{} else
{m_24052.call(null);
if((count_24051 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__24053 = (count_24051 + (1));
count_24051 = G__24053;
continue;
}
} else
{}
