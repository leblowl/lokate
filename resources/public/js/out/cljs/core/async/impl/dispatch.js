...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_24277 = (0);while(true){
var m_24278 = cljs.core.async.impl.dispatch.tasks.pop();if((m_24278 == null))
{} else
{m_24278.call(null);
if((count_24277 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__24279 = (count_24277 + (1));
count_24277 = G__24279;
continue;
}
} else
{}
