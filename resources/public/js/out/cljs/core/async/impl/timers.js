...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_24197 = (0);while(true){
if((i_24197 < arr.length))
{(arr[i_24197] = null);
{
...
{var i_24204 = (self__.level + (1));while(true){
if((i_24204 <= (new_level + (1))))
{(update[i_24204] = self__.header);
{
var G__24205 = (i_24204 + (1));
i_24204 = G__24205;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_24206 = (0);while(true){
if((i_24206 <= self__.level))
{var links_24207 = (update[i_24206]).forward;if(((links_24207[i_24206]) === x__$1))
{(links_24207[i_24206] = (x__$1.forward[i_24206]));
{
var G__24208 = (i_24206 + (1));
i_24206 = G__24208;
continue;
}
} else
{{
var G__24209 = (i_24206 + (1));
i_24206 = G__24209;
continue;
}
}
