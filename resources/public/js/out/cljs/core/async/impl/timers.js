...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_23971 = (0);while(true){
if((i_23971 < arr.length))
{(arr[i_23971] = null);
{
var G__23972 = (i_23971 + (1));
i_23971 = G__23972;
continue;
}
} else
...
{var i_23978 = (self__.level + (1));while(true){
if((i_23978 <= (new_level + (1))))
{(update[i_23978] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_23980 = (0);while(true){
if((i_23980 <= self__.level))
{var links_23981 = (update[i_23980]).forward;if(((links_23981[i_23980]) === x__$1))
{(links_23981[i_23980] = (x__$1.forward[i_23980]));
{
var G__23982 = (i_23980 + (1));
i_23980 = G__23982;
continue;
}
} else
{{
var G__23983 = (i_23980 + (1));
i_23980 = G__23983;
continue;
}
}
