...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_27348 = (0);while(true){
if((i_27348 < arr.length))
{(arr[i_27348] = null);
{
...
{var i_27361 = (self__.level + (1));while(true){
if((i_27361 <= (new_level + (1))))
{(update[i_27361] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_27363 = (0);while(true){
if((i_27363 <= self__.level))
{var links_27364 = (update[i_27363]).forward;if(((links_27364[i_27363]) === x__$1))
{(links_27364[i_27363] = (x__$1.forward[i_27363]));
{
