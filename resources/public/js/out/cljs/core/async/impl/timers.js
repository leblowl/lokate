...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_30900 = (0);while(true){
if((i_30900 < arr.length))
{(arr[i_30900] = null);
{
...
{var i_30907 = (self__.level + (1));while(true){
if((i_30907 <= (new_level + (1))))
{(update[i_30907] = self__.header);
{
var G__30908 = (i_30907 + (1));
i_30907 = G__30908;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_30909 = (0);while(true){
if((i_30909 <= self__.level))
{var links_30910 = (update[i_30909]).forward;if(((links_30910[i_30909]) === x__$1))
{(links_30910[i_30909] = (x__$1.forward[i_30909]));
{
var G__30911 = (i_30909 + (1));
i_30909 = G__30911;
continue;
}
} else
{{
var G__30912 = (i_30909 + (1));
i_30909 = G__30912;
continue;
}
}
