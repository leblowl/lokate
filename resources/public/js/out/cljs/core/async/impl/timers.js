...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_25845 = (0);while(true){
if((i_25845 < arr.length))
{(arr[i_25845] = null);
{
...
{var i_25858 = (self__.level + (1));while(true){
if((i_25858 <= (new_level + (1))))
{(update[i_25858] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_25860 = (0);while(true){
if((i_25860 <= self__.level))
{var links_25861 = (update[i_25860]).forward;if(((links_25861[i_25860]) === x__$1))
{(links_25861[i_25860] = (x__$1.forward[i_25860]));
{
var G__25862 = (i_25860 + (1));
i_25860 = G__25862;
continue;
}
} else
{{
var G__25863 = (i_25860 + (1));
i_25860 = G__25863;
continue;
}
}
