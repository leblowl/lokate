...
*/
cljs_http.util.build_url = (function build_url(p__26212){var map__26215 = p__26212;var map__26215__$1 = ((cljs.core.seq_QMARK_.call(null,map__26215))?cljs.core.apply.call(null,cljs.core.hash_map,map__26215):map__26215);var query_string = cljs.core.get.call(null,map__26215__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));var uri = cljs.core.get.call(null,map__26215__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));var server_port = cljs.core.get.call(null,map__26215__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));var server_name = cljs.core.get.call(null,map__26215__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));var scheme = cljs.core.get.call(null,map__26215__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__26216 = (new goog.Uri());G__26216.setScheme(cljs.core.name.call(null,(function (){var or__12546__auto__ = scheme;if(cljs.core.truth_(or__12546__auto__))
{return or__12546__auto__;
} else
{return new cljs.core.Keyword(null,"http","http",382524695);
}
})()));
G__26216.setDomain(server_name);
G__26216.setPort(server_port);
G__26216.setPath(uri);
G__26216.setQuery(query_string,true);
return G__26216;
})()));
});
/**
...
cljs_http.util.parse_headers = (function parse_headers(headers){return cljs.core.reduce.call(null,(function (p1__26218_SHARP_,p2__26217_SHARP_){var vec__26220 = clojure.string.split.call(null,p2__26217_SHARP_,/:\s+/);var k = cljs.core.nth.call(null,vec__26220,(0),null);var v = cljs.core.nth.call(null,vec__26220,(1),null);if(cljs.core.truth_((function (){var or__12546__auto__ = clojure.string.blank_QMARK_.call(null,k);if(cljs.core.truth_(or__12546__auto__))
{return or__12546__auto__;
} else
...
{return cljs.core.assoc.call(null,p1__26218_SHARP_,clojure.string.lower_case.call(null,k),v);
}
