...
*/
cljs_http.util.build_url = (function build_url(p__23715){var map__23718 = p__23715;var map__23718__$1 = ((cljs.core.seq_QMARK_.call(null,map__23718))?cljs.core.apply.call(null,cljs.core.hash_map,map__23718):map__23718);var query_string = cljs.core.get.call(null,map__23718__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));var uri = cljs.core.get.call(null,map__23718__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));var server_port = cljs.core.get.call(null,map__23718__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));var server_name = cljs.core.get.call(null,map__23718__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));var scheme = cljs.core.get.call(null,map__23718__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__23719 = (new goog.Uri());G__23719.setScheme(cljs.core.name.call(null,(function (){var or__12547__auto__ = scheme;if(cljs.core.truth_(or__12547__auto__))
...
cljs_http.util.parse_headers = (function parse_headers(headers){return cljs.core.reduce.call(null,(function (p1__23721_SHARP_,p2__23720_SHARP_){var vec__23723 = clojure.string.split.call(null,p2__23720_SHARP_,/:\s+/);var k = cljs.core.nth.call(null,vec__23723,(0),null);var v = cljs.core.nth.call(null,vec__23723,(1),null);if(cljs.core.truth_((function (){var or__12547__auto__ = clojure.string.blank_QMARK_.call(null,k);if(cljs.core.truth_(or__12547__auto__))
{return or__12547__auto__;
} else
...
}),cljs.core.PersistentArrayMap.EMPTY,clojure.string.split.call(null,(function (){var or__12547__auto__ = headers;if(cljs.core.truth_(or__12547__auto__))
{return or__12547__auto__;
} else
{return "";
}
