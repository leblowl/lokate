...
*/
cljs_http.util.build_url = (function build_url(p__24799){var map__24802 = p__24799;var map__24802__$1 = ((cljs.core.seq_QMARK_.call(null,map__24802))?cljs.core.apply.call(null,cljs.core.hash_map,map__24802):map__24802);var query_string = cljs.core.get.call(null,map__24802__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));var uri = cljs.core.get.call(null,map__24802__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));var server_port = cljs.core.get.call(null,map__24802__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));var server_name = cljs.core.get.call(null,map__24802__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));var scheme = cljs.core.get.call(null,map__24802__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__24803 = (new goog.Uri());G__24803.setScheme(cljs.core.name.call(null,(function (){var or__12548__auto__ = scheme;if(cljs.core.truth_(or__12548__auto__))
{return or__12548__auto__;
} else
{return new cljs.core.Keyword(null,"http","http",382524695);
}
})()));
G__24803.setDomain(server_name);
G__24803.setPort(server_port);
G__24803.setPath(uri);
G__24803.setQuery(query_string,true);
return G__24803;
})()));
});
/**
...
cljs_http.util.parse_headers = (function parse_headers(headers){return cljs.core.reduce.call(null,(function (p1__24805_SHARP_,p2__24804_SHARP_){var vec__24807 = clojure.string.split.call(null,p2__24804_SHARP_,/:\s+/);var k = cljs.core.nth.call(null,vec__24807,(0),null);var v = cljs.core.nth.call(null,vec__24807,(1),null);if(cljs.core.truth_((function (){var or__12548__auto__ = clojure.string.blank_QMARK_.call(null,k);if(cljs.core.truth_(or__12548__auto__))
{return or__12548__auto__;
} else
...
{return cljs.core.assoc.call(null,p1__24805_SHARP_,clojure.string.lower_case.call(null,k),v);
}
}),cljs.core.PersistentArrayMap.EMPTY,clojure.string.split.call(null,(function (){var or__12548__auto__ = headers;if(cljs.core.truth_(or__12548__auto__))
{return or__12548__auto__;
} else
{return "";
}
