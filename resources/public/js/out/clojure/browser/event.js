...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj25199 = {};return obj25199;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__12534__auto__ = this$;if(and__12534__auto__)
...
{var x__13183__auto__ = (((this$ == null))?null:this$);return (function (){var or__12546__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__13183__auto__)]);if(or__12546__auto__)
{return or__12546__auto__;
} else
{var or__12546__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__12546__auto____$1)
...
return (function (p__25200){var vec__25201 = p__25200;var k = cljs.core.nth.call(null,vec__25201,(0),null);var v = cljs.core.nth.call(null,vec__25201,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__25202){var vec__25203 = p__25202;var k = cljs.core.nth.call(null,vec__25203,(0),null);var v = cljs.core.nth.call(null,vec__25203,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
