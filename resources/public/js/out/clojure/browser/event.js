...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj27112 = {};return obj27112;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__12535__auto__ = this$;if(and__12535__auto__)
...
{var x__13184__auto__ = (((this$ == null))?null:this$);return (function (){var or__12547__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__13184__auto__)]);if(or__12547__auto__)
{return or__12547__auto__;
} else
{var or__12547__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__12547__auto____$1)
...
return (function (p__27113){var vec__27114 = p__27113;var k = cljs.core.nth.call(null,vec__27114,(0),null);var v = cljs.core.nth.call(null,vec__27114,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__27115){var vec__27116 = p__27115;var k = cljs.core.nth.call(null,vec__27116,(0),null);var v = cljs.core.nth.call(null,vec__27116,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
