...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj25111 = {};return obj25111;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__12536__auto__ = this$;if(and__12536__auto__)
...
{var x__13185__auto__ = (((this$ == null))?null:this$);return (function (){var or__12548__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__13185__auto__)]);if(or__12548__auto__)
{return or__12548__auto__;
} else
{var or__12548__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__12548__auto____$1)
...
return (function (p__25112){var vec__25113 = p__25112;var k = cljs.core.nth.call(null,vec__25113,(0),null);var v = cljs.core.nth.call(null,vec__25113,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__25114){var vec__25115 = p__25114;var k = cljs.core.nth.call(null,vec__25115,(0),null);var v = cljs.core.nth.call(null,vec__25115,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
