...
{{
var G__27307 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27307;
continue;
}
} else
...
{var pred__27311 = cljs.core._EQ_;var expr__27312 = limit;if(cljs.core.truth_(pred__27311.call(null,(1),expr__27312)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27311.call(null,(2),expr__27312)))
...
var G__27314 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27315 = (limit__$1 - (1));
var G__27316 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27314;
limit__$1 = G__27315;
parts = G__27316;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27318 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27318))
{var replacement_27319 = temp__4124__auto___27318;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27319)));
} else
{buffer.append(ch);
}
{
var G__27320 = (index + (1));
index = G__27320;
continue;
}
}
