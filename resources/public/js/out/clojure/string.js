...
{return s.replace((new RegExp((function (){var G__26848 = match;return goog.string.regExpEscape(G__26848);
})(),"g")),replacement);
} else
...
{{
var G__26849 = cljs.core.pop(v__$1);
v__$1 = G__26849;
continue;
}
} else
...
{var pred__26857 = cljs.core._EQ_;var expr__26858 = limit;if(cljs.core.truth_((function (){var G__26860 = (1);var G__26861 = expr__26858;return (pred__26857.cljs$core$IFn$_invoke$arity$2 ? pred__26857.cljs$core$IFn$_invoke$arity$2(G__26860,G__26861) : pred__26857.call(null,G__26860,G__26861));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__26862 = (2);var G__26863 = expr__26858;return (pred__26857.cljs$core$IFn$_invoke$arity$2 ? pred__26857.cljs$core$IFn$_invoke$arity$2(G__26862,G__26863) : pred__26857.call(null,G__26862,G__26863));
})()))
...
var G__26867 = s__$1.substring((index + cljs.core.count(m)));
var G__26868 = (limit__$1 - (1));
var G__26869 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__26867;
limit__$1 = G__26868;
parts = G__26869;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__26871 = s;return goog.string.trim(G__26871);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__26873 = s;return goog.string.trimLeft(G__26873);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__26875 = s;return goog.string.trimRight(G__26875);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__26878 = s;return goog.string.isEmptySafe(G__26878);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___26879 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___26879))
{var replacement_26880 = temp__4124__auto___26879;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_26880)));
} else
{buffer.append(ch);
}
{
var G__26881 = (index + (1));
index = G__26881;
continue;
}
}
