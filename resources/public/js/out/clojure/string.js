...
{return s.replace((new RegExp((function (){var G__23139 = match;return goog.string.regExpEscape(G__23139);
})(),"g")),replacement);
} else
...
{{
var G__23140 = cljs.core.pop(v__$1);
v__$1 = G__23140;
continue;
}
} else
...
{var pred__23148 = cljs.core._EQ_;var expr__23149 = limit;if(cljs.core.truth_((function (){var G__23151 = (1);var G__23152 = expr__23149;return (pred__23148.cljs$core$IFn$_invoke$arity$2 ? pred__23148.cljs$core$IFn$_invoke$arity$2(G__23151,G__23152) : pred__23148.call(null,G__23151,G__23152));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__23153 = (2);var G__23154 = expr__23149;return (pred__23148.cljs$core$IFn$_invoke$arity$2 ? pred__23148.cljs$core$IFn$_invoke$arity$2(G__23153,G__23154) : pred__23148.call(null,G__23153,G__23154));
})()))
...
var G__23158 = s__$1.substring((index + cljs.core.count(m)));
var G__23159 = (limit__$1 - (1));
var G__23160 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__23158;
limit__$1 = G__23159;
parts = G__23160;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__23162 = s;return goog.string.trim(G__23162);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__23164 = s;return goog.string.trimLeft(G__23164);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__23166 = s;return goog.string.trimRight(G__23166);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__23169 = s;return goog.string.isEmptySafe(G__23169);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___23170 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___23170))
{var replacement_23171 = temp__4124__auto___23170;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_23171)));
} else
{buffer.append(ch);
}
{
var G__23172 = (index + (1));
index = G__23172;
continue;
}
}
