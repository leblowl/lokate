...
{{
var G__32591 = cljs.core.pop.call(null,v__$1);
v__$1 = G__32591;
continue;
}
} else
...
{var pred__32595 = cljs.core._EQ_;var expr__32596 = limit;if(cljs.core.truth_(pred__32595.call(null,(1),expr__32596)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__32595.call(null,(2),expr__32596)))
...
var G__32598 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__32599 = (limit__$1 - (1));
var G__32600 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__32598;
limit__$1 = G__32599;
parts = G__32600;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___32602 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___32602))
{var replacement_32603 = temp__4124__auto___32602;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_32603)));
} else
{buffer.append(ch);
}
{
var G__32604 = (index + (1));
index = G__32604;
continue;
}
}
