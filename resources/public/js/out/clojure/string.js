...
{return s.replace((new RegExp((function (){var G__23090 = match;return goog.string.regExpEscape(G__23090);
})(),"g")),replacement);
} else
...
{{
var G__23091 = cljs.core.pop(v__$1);
v__$1 = G__23091;
continue;
}
} else
...
{var pred__23099 = cljs.core._EQ_;var expr__23100 = limit;if(cljs.core.truth_((function (){var G__23102 = (1);var G__23103 = expr__23100;return (pred__23099.cljs$core$IFn$_invoke$arity$2 ? pred__23099.cljs$core$IFn$_invoke$arity$2(G__23102,G__23103) : pred__23099.call(null,G__23102,G__23103));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__23104 = (2);var G__23105 = expr__23100;return (pred__23099.cljs$core$IFn$_invoke$arity$2 ? pred__23099.cljs$core$IFn$_invoke$arity$2(G__23104,G__23105) : pred__23099.call(null,G__23104,G__23105));
})()))
...
var G__23109 = s__$1.substring((index + cljs.core.count(m)));
var G__23110 = (limit__$1 - (1));
var G__23111 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__23109;
limit__$1 = G__23110;
parts = G__23111;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__23113 = s;return goog.string.trim(G__23113);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__23115 = s;return goog.string.trimLeft(G__23115);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__23117 = s;return goog.string.trimRight(G__23117);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__23120 = s;return goog.string.isEmptySafe(G__23120);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___23121 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___23121))
{var replacement_23122 = temp__4124__auto___23121;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_23122)));
} else
{buffer.append(ch);
}
{
