...
{{
var G__24683 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24683;
continue;
}
} else
...
{var pred__24687 = cljs.core._EQ_;var expr__24688 = limit;if(cljs.core.truth_(pred__24687.call(null,(1),expr__24688)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24687.call(null,(2),expr__24688)))
...
var G__24690 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24691 = (limit__$1 - (1));
var G__24692 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__24690;
limit__$1 = G__24691;
parts = G__24692;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___24694 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___24694))
{var replacement_24695 = temp__4124__auto___24694;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_24695)));
} else
{buffer.append(ch);
}
{
var G__24696 = (index + (1));
index = G__24696;
continue;
}
}
