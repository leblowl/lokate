...
{return s.replace((new RegExp((function (){var G__27137 = match;return goog.string.regExpEscape(G__27137);
})(),"g")),replacement);
} else
...
{{
var G__27138 = cljs.core.pop(v__$1);
v__$1 = G__27138;
continue;
}
} else
...
{var pred__27146 = cljs.core._EQ_;var expr__27147 = limit;if(cljs.core.truth_((function (){var G__27149 = (1);var G__27150 = expr__27147;return (pred__27146.cljs$core$IFn$_invoke$arity$2 ? pred__27146.cljs$core$IFn$_invoke$arity$2(G__27149,G__27150) : pred__27146.call(null,G__27149,G__27150));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__27151 = (2);var G__27152 = expr__27147;return (pred__27146.cljs$core$IFn$_invoke$arity$2 ? pred__27146.cljs$core$IFn$_invoke$arity$2(G__27151,G__27152) : pred__27146.call(null,G__27151,G__27152));
})()))
...
var G__27156 = s__$1.substring((index + cljs.core.count(m)));
var G__27157 = (limit__$1 - (1));
var G__27158 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__27156;
limit__$1 = G__27157;
parts = G__27158;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__27160 = s;return goog.string.trim(G__27160);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__27162 = s;return goog.string.trimLeft(G__27162);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__27164 = s;return goog.string.trimRight(G__27164);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__27167 = s;return goog.string.isEmptySafe(G__27167);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___27168 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___27168))
{var replacement_27169 = temp__4124__auto___27168;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27169)));
} else
{buffer.append(ch);
}
{
