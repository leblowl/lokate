...
{var pred__11554 = cljs.core._EQ_;var expr__11555 = limit;if(cljs.core.truth_(pred__11554.call(null,(1),expr__11555)))
...
var G__11557 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11558 = (limit__$1 - (1));
var G__11559 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__11557;
limit__$1 = G__11558;
parts = G__11559;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___11561 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___11561))
{var replacement_11562 = temp__4124__auto___11561;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_11562)));
} else
{buffer.append(ch);
}
{
var G__11563 = (index + (1));
index = G__11563;
continue;
}
}
