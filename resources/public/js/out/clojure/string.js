...
{{
var G__26846 = cljs.core.pop.call(null,v__$1);
v__$1 = G__26846;
continue;
}
} else
...
{var pred__26850 = cljs.core._EQ_;var expr__26851 = limit;if(cljs.core.truth_(pred__26850.call(null,(1),expr__26851)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__26850.call(null,(2),expr__26851)))
...
var G__26853 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__26854 = (limit__$1 - (1));
var G__26855 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__26853;
limit__$1 = G__26854;
parts = G__26855;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___26857 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___26857))
{var replacement_26858 = temp__4124__auto___26857;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_26858)));
} else
{buffer.append(ch);
}
{
