...
var this$__$1 = this;var map_options = {"zoom": (6), "center": {"lng": (0), "lat": (0)}};var map = (new google.maps.Map(document.getElementById("map-canvas"),map_options));var G__16134_16143 = map;var G__16135_16144 = "rightclick";var G__16136_16145 = ((function (G__16134_16143,G__16135_16144,map_options,map,this$__$1){
return (function (evt){var marker = hivez.core.mark_pos(map,evt.latLng);document.getElementById("name").blur();
document.getElementById("notes").blur();
hivez.core.add_hive(self__.data,marker);
...
hivez.core.editable = (function editable(data,owner,p__16154){var map__16167 = p__16154;var map__16167__$1 = ((cljs.core.seq_QMARK_(map__16167))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__16167):map__16167);var opts = map__16167__$1;var on_edit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16167__$1,cljs.core.constant$keyword$143);var edit_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16167__$1,cljs.core.constant$keyword$144);if(typeof hivez.core.t16168 !== 'undefined')
{} else
{
/**
* @constructor
*/
hivez.core.t16168 = (function (edit_key,on_edit,opts,map__16167,p__16154,owner,data,editable,meta16169){
...
hivez.core.t16168.cljs$lang$ctorPrWriter = ((function (map__16167,map__16167__$1,opts,on_edit,edit_key){
...
});})(map__16167,map__16167__$1,opts,on_edit,edit_key))
;
hivez.core.t16168.prototype.om$core$IRenderState$ = true;
hivez.core.t16168.prototype.om$core$IRenderState$render_state$arity$2 = ((function (map__16167,map__16167__$1,opts,on_edit,edit_key){
return (function (_,p__16171){var self__ = this;
var map__16172 = p__16171;var map__16172__$1 = ((cljs.core.seq_QMARK_(map__16172))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__16172):map__16172);var editing = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16172__$1,cljs.core.constant$keyword$142);var ___$1 = this;var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(self__.data,self__.edit_key);var G__16173 = null;var G__16174 = (function (){var G__16176 = {"onClick": ((function (G__16173,text,___$1,map__16172,map__16172__$1,editing,map__16167,map__16167__$1,opts,on_edit,edit_key){
return (function (){return om.core.set_state_BANG_.cljs$core$IFn$_invoke$arity$3(self__.owner,cljs.core.constant$keyword$142,true);
});})(G__16173,text,___$1,map__16172,map__16172__$1,editing,map__16167,map__16167__$1,opts,on_edit,edit_key))
, "style": hivez.core.display(cljs.core.not(editing))};var G__16177 = text;return React.DOM.span(G__16176,G__16177);
})();var G__16175 = (function (){var G__16178 = {"onBlur": ((function (G__16173,G__16174,text,___$1,map__16172,map__16172__$1,editing,map__16167,map__16167__$1,opts,on_edit,edit_key){
...
});})(G__16173,G__16174,text,___$1,map__16172,map__16172__$1,editing,map__16167,map__16167__$1,opts,on_edit,edit_key))
, "onKeyPress": ((function (G__16173,G__16174,text,___$1,map__16172,map__16172__$1,editing,map__16167,map__16167__$1,opts,on_edit,edit_key){
...
, "onChange": ((function (G__16173,G__16174,text,___$1,map__16172,map__16172__$1,editing,map__16167,map__16167__$1,opts,on_edit,edit_key){
...
, "value": text, "style": hivez.core.display(editing)};return (om.dom.input.cljs$core$IFn$_invoke$arity$1 ? om.dom.input.cljs$core$IFn$_invoke$arity$1(G__16178) : om.dom.input.call(null,G__16178));
})();return React.DOM.div(G__16173,G__16174,G__16175);
});})(map__16167,map__16167__$1,opts,on_edit,edit_key))
;
hivez.core.t16168.prototype.om$core$IInitState$ = true;
hivez.core.t16168.prototype.om$core$IInitState$init_state$arity$1 = ((function (map__16167,map__16167__$1,opts,on_edit,edit_key){
return (function (_){var self__ = this;
var ___$1 = this;return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$142,false], null);
});})(map__16167,map__16167__$1,opts,on_edit,edit_key))
;
hivez.core.t16168.prototype.cljs$core$IMeta$_meta$arity$1 = ((function (map__16167,map__16167__$1,opts,on_edit,edit_key){
return (function (_16170){var self__ = this;
var _16170__$1 = this;return self__.meta16169;
});})(map__16167,map__16167__$1,opts,on_edit,edit_key))
;
hivez.core.t16168.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = ((function (map__16167,map__16167__$1,opts,on_edit,edit_key){
return (function (_16170,meta16169__$1){var self__ = this;
var _16170__$1 = this;return (new hivez.core.t16168(self__.edit_key,self__.on_edit,self__.opts,self__.map__16167,self__.p__16154,self__.owner,self__.data,self__.editable,meta16169__$1));
});})(map__16167,map__16167__$1,opts,on_edit,edit_key))
;
hivez.core.__GT_t16168 = ((function (map__16167,map__16167__$1,opts,on_edit,edit_key){
return (function __GT_t16168(edit_key__$1,on_edit__$1,opts__$1,map__16167__$2,p__16154__$1,owner__$1,data__$1,editable__$1,meta16169){return (new hivez.core.t16168(edit_key__$1,on_edit__$1,opts__$1,map__16167__$2,p__16154__$1,owner__$1,data__$1,editable__$1,meta16169));
});})(map__16167,map__16167__$1,opts,on_edit,edit_key))
;
}
return (new hivez.core.t16168(edit_key,on_edit,opts,map__16167__$1,p__16154,owner,data,editable,null));
});
...
var this$__$1 = this;var G__16194 = {"className": "info", "id": "info"};var G__16195 = om.core.build.cljs$core$IFn$_invoke$arity$3(hivez.core.editable,self__.hive,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$45,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$144,cljs.core.constant$keyword$64,cljs.core.constant$keyword$143,hivez.core.handle_change], null)], null));var G__16196 = (function (){var G__16199 = {"className": "origin"};var G__16200 = hivez.core.display_origin(self__.hive);return React.DOM.div(G__16199,G__16200);
...
})();var G__16198 = om.core.build.cljs$core$IFn$_invoke$arity$3(hivez.core.editable,self__.hive,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$45,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$144,cljs.core.constant$keyword$64,cljs.core.constant$keyword$143,hivez.core.handle_change], null)], null));return React.DOM.div(G__16194,G__16195,G__16196,G__16197,G__16198);
});
...
hivez.core.app = (function app(data,owner){if(typeof hivez.core.t16215 !== 'undefined')
{} else
{
/**
* @constructor
*/
hivez.core.t16215 = (function (owner,data,app,meta16216){
this.owner = owner;
this.data = data;
this.app = app;
...
hivez.core.t16215.cljs$lang$type = true;
hivez.core.t16215.cljs$lang$ctorStr = "hivez.core/t16215";
hivez.core.t16215.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write(writer__4218__auto__,"hivez.core/t16215");
});
hivez.core.t16215.prototype.om$core$IRender$ = true;
hivez.core.t16215.prototype.om$core$IRender$render$arity$1 = (function (this__5247__auto__){var self__ = this;
var this__5247__auto____$1 = this;var G__16218 = {"className": "content-liner"};var G__16219 = (function (){var G__16220 = {"className": ("flex-container"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$131.cljs$core$IFn$_invoke$arity$1(self__.data),cljs.core.constant$keyword$133))?" column":" row")))};var G__16221 = (function (){var G__16223 = {"className": ("one"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.constant$keyword$131.cljs$core$IFn$_invoke$arity$1(self__.data),cljs.core.constant$keyword$133))?" vert":" flat")))};var G__16224 = om.core.build.cljs$core$IFn$_invoke$arity$2(hivez.core.goog_map,self__.data);return React.DOM.div(G__16223,G__16224);
...
})();return React.DOM.div(G__16218,G__16219);
});
hivez.core.t16215.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16217){var self__ = this;
var _16217__$1 = this;return self__.meta16216;
});
hivez.core.t16215.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16217,meta16216__$1){var self__ = this;
var _16217__$1 = this;return (new hivez.core.t16215(self__.owner,self__.data,self__.app,meta16216__$1));
});
hivez.core.__GT_t16215 = (function __GT_t16215(owner__$1,data__$1,app__$1,meta16216){return (new hivez.core.t16215(owner__$1,data__$1,app__$1,meta16216));
});
}
return (new hivez.core.t16215(owner,data,app,null));
});
