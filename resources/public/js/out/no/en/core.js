...
var url_encode__delegate = function (s,p__21795){var vec__21797 = p__21795;var encoding = cljs.core.nth.call(null,vec__21797,(0),null);if(cljs.core.truth_(s))
...
var p__21795 = null;if (arguments.length > 1) {
  p__21795 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_encode__delegate.call(this,s,p__21795);};
url_encode.cljs$lang$maxFixedArity = 1;
url_encode.cljs$lang$applyTo = (function (arglist__21798){
var s = cljs.core.first(arglist__21798);
var p__21795 = cljs.core.rest(arglist__21798);
return url_encode__delegate(s,p__21795);
});
...
var url_decode__delegate = function (s,p__21799){var vec__21801 = p__21799;var encoding = cljs.core.nth.call(null,vec__21801,(0),null);if(cljs.core.truth_(s))
...
var p__21799 = null;if (arguments.length > 1) {
  p__21799 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return url_decode__delegate.call(this,s,p__21799);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__21802){
var s = cljs.core.first(arglist__21802);
var p__21799 = cljs.core.rest(arglist__21802);
return url_decode__delegate(s,p__21799);
});
...
{var G__21805 = clojure.string.upper_case.call(null,unit);switch (G__21805) {
default:
var G__21806 = unit;switch (G__21806) {
case "M":
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__21809_SHARP_){return parseInt(p1__21809_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__21810_SHARP_){return parseInt(p1__21810_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__21811_SHARP_){return parseFloat(p1__21811_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__21812_SHARP_){return parseFloat(p1__21812_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__21815_SHARP_){return clojure.string.join.call(null,"=",p1__21815_SHARP_);
}),cljs.core.map.call(null,(function (p1__21814_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__21814_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__21814_SHARP_))],null));
}),cljs.core.remove.call(null,(function (p1__21813_SHARP_){return clojure.string.blank_QMARK_.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__21813_SHARP_))));
...
{var query_params = new cljs.core.Keyword(null,"query-params","query-params",900640534).cljs$core$IFn$_invoke$arity$1(m);return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m))?(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m)))+"://"):null))+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var map__21817 = m;var map__21817__$1 = ((cljs.core.seq_QMARK_.call(null,map__21817))?cljs.core.apply.call(null,cljs.core.hash_map,map__21817):map__21817);var password = cljs.core.get.call(null,map__21817__$1,new cljs.core.Keyword(null,"password","password",417022471));var user = cljs.core.get.call(null,map__21817__$1,new cljs.core.Keyword(null,"user","user",1532431356));if(cljs.core.truth_(user))
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__21820_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__21820_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__21820_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__21819_SHARP_){return cljs.core._EQ_.call(null,(2),cljs.core.count.call(null,p1__21819_SHARP_));
}),cljs.core.map.call(null,(function (p1__21818_SHARP_){return clojure.string.split.call(null,p1__21818_SHARP_,/=/);
...
}catch (e21822){if((e21822 instanceof Error))
{var e = e21822;if((n__$1 === (0)))
{throw e;
} else
{return null;
}
