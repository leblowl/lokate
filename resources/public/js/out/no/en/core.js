...
var url_encode__delegate = function (s,p__23866){var vec__23868 = p__23866;var encoding = cljs.core.nth.call(null,vec__23868,(0),null);if(cljs.core.truth_(s))
...
var p__23866 = cljs.core.rest(arglist__23869);
...
var url_decode__delegate = function (s,p__23870){var vec__23872 = p__23870;var encoding = cljs.core.nth.call(null,vec__23872,(0),null);if(cljs.core.truth_(s))
...
url_decode.cljs$lang$applyTo = (function (arglist__23873){
var s = cljs.core.first(arglist__23873);
var p__23870 = cljs.core.rest(arglist__23873);
...
{var G__23876 = clojure.string.upper_case.call(null,unit);switch (G__23876) {
default:
var G__23877 = unit;switch (G__23877) {
case "M":
...
*/
no.en.core.parse_integer = (function parse_integer(s){return no.en.core.parse_number.call(null,s,(function (p1__23880_SHARP_){return parseInt(p1__23880_SHARP_);
}));
});
/**
* Parse `s` as a long number.
*/
no.en.core.parse_long = (function parse_long(s){return no.en.core.parse_number.call(null,s,(function (p1__23881_SHARP_){return parseInt(p1__23881_SHARP_);
}));
});
/**
* Parse `s` as a double number.
*/
no.en.core.parse_double = (function parse_double(s){return no.en.core.parse_number.call(null,s,(function (p1__23882_SHARP_){return parseFloat(p1__23882_SHARP_);
}));
});
/**
* Parse `s` as a float number.
*/
no.en.core.parse_float = (function parse_float(s){return no.en.core.parse_number.call(null,s,(function (p1__23883_SHARP_){return parseFloat(p1__23883_SHARP_);
}));
});
/**
* Format the map `m` into a query parameter string.
*/
no.en.core.format_query_params = (function format_query_params(m){var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__23886_SHARP_){return clojure.string.join.call(null,"=",p1__23886_SHARP_);
}),cljs.core.map.call(null,(function (p1__23885_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__23885_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__23885_SHARP_))],null));
}),cljs.core.remove.call(null,(function (p1__23884_SHARP_){return clojure.string.blank_QMARK_.call(null,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.second.call(null,p1__23884_SHARP_))));
...
{var query_params = new cljs.core.Keyword(null,"query-params","query-params",900640534).cljs$core$IFn$_invoke$arity$1(m);return (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m))?(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,new cljs.core.Keyword(null,"scheme","scheme",90199613).cljs$core$IFn$_invoke$arity$1(m)))+"://"):null))+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var map__23888 = m;var map__23888__$1 = ((cljs.core.seq_QMARK_.call(null,map__23888))?cljs.core.apply.call(null,cljs.core.hash_map,map__23888):map__23888);var password = cljs.core.get.call(null,map__23888__$1,new cljs.core.Keyword(null,"password","password",417022471));var user = cljs.core.get.call(null,map__23888__$1,new cljs.core.Keyword(null,"user","user",1532431356));if(cljs.core.truth_(user))
...
{return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__23891_SHARP_){return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__23891_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__23891_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__23890_SHARP_){return cljs.core._EQ_.call(null,(2),cljs.core.count.call(null,p1__23890_SHARP_));
}),cljs.core.map.call(null,(function (p1__23889_SHARP_){return clojure.string.split.call(null,p1__23889_SHARP_,/=/);
