...
sablono.util.ToString = (function (){var obj22296 = {};
return obj22296;
})();
...
return (function (){var or__3758__auto__ = (sablono.util.to_str[goog.typeOf(x__4402__auto__)]);
if(or__3758__auto__){
return or__3758__auto__;
} else {
var or__3758__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj22298 = {};
return obj22298;
})();
...
var x__4402__auto__ = (((x == null))?null:x);
return (function (){var or__3758__auto__ = (sablono.util.to_uri[goog.typeOf(x__4402__auto__)]);
if(or__3758__auto__){
return or__3758__auto__;
} else {
var or__3758__auto____$1 = (sablono.util.to_uri["_"]);
if(or__3758__auto____$1){
return or__3758__auto____$1;
} else {
...
while (G__22299__i < G__22299__a.length) {G__22299__a[G__22299__i] = arguments[G__22299__i + 0]; ++G__22299__i;}
  xs = new cljs.core.IndexedSeq(G__22299__a,0);
} 
return as_str__delegate.call(this,xs);};
as_str.cljs$lang$maxFixedArity = 0;
as_str.cljs$lang$applyTo = (function (arglist__22300){
var xs = cljs.core.seq(arglist__22300);
...
var vec__22302 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__22302,(0),null);
var words = cljs.core.nthnext.call(null,vec__22302,(1));
...
var G__22304 = clojure.set.rename_keys.call(null,m,kmap);
var G__22304__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__22304,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__22304);
return G__22304__$1;
} else {
return m;
}
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__22305_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__22305_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__22305_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__22305_SHARP_)){
...
while (G__22306__i < G__22306__a.length) {G__22306__a[G__22306__i] = arguments[G__22306__i + 0]; ++G__22306__i;}
  maps = new cljs.core.IndexedSeq(G__22306__a,0);
} 
return merge_with_class__delegate.call(this,maps);};
merge_with_class.cljs$lang$maxFixedArity = 0;
merge_with_class.cljs$lang$applyTo = (function (arglist__22307){
var maps = cljs.core.seq(arglist__22307);
...
var vec__22311 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__22311,(0),null);
var names = cljs.core.nth.call(null,vec__22311,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__22311,tag_name,names){
return (function (p1__22308_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__22308_SHARP_));
});})(matches,vec__22311,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__22311,tag_name,names){
return (function (p1__22309_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__22309_SHARP_));
});})(matches,vec__22311,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__22312){
var vec__22315 = p__22312;
var tag = cljs.core.nth.call(null,vec__22315,(0),null);
var content = cljs.core.nthnext.call(null,vec__22315,(1));
...
var vec__22316 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__22316,(0),null);
var id = cljs.core.nth.call(null,vec__22316,(1),null);
var class$ = cljs.core.nth.call(null,vec__22316,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__3758__auto__ = x__$1.hasDomain();
