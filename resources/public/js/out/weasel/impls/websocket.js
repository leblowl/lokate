...
goog.require('clojure.browser.net');
goog.require('clojure.browser.net');
weasel.impls.websocket.IWebSocket = (function (){var obj27138 = {};return obj27138;
})();
weasel.impls.websocket.open_QMARK_ = (function open_QMARK_(this$){if((function (){var and__12535__auto__ = this$;if(and__12535__auto__)
...
{var x__13184__auto__ = (((this$ == null))?null:this$);return (function (){var or__12547__auto__ = (weasel.impls.websocket.open_QMARK_[goog.typeOf(x__13184__auto__)]);if(or__12547__auto__)
{return or__12547__auto__;
} else
{var or__12547__auto____$1 = (weasel.impls.websocket.open_QMARK_["_"]);if(or__12547__auto____$1)
...
return (function (p__27139){var vec__27140 = p__27139;var k = cljs.core.nth.call(null,vec__27140,(0),null);var v = cljs.core.nth.call(null,vec__27140,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
